...
exports.ProgressViewProvider = void 0;
const vscode = __importStar(require("vscode"));
const fs = __importStar(require("fs"));
const path = __importStar(require("path"));
class ProgressViewProvider {
    extensionUri;
    config;
    _view;
    activityWatcher;
    ...
    getCompletedStories(events) {
        const completed = [];
        const storyStarts = new Map();
...
<body>
  ...
  <div class="activity-log" id="activityLog">
    ...
    <div class="ev-row">
      ...
      ${this.getEventIcon(ev.type, ev.code)}
...
exports.ProgressViewProvider = ProgressViewProvider;
//# sourceMappingURL=progress-panel.js.map